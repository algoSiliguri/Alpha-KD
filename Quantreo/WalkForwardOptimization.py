...
class WalkForwardOptimization:
  ...
  def get_combinations(self):
      ...
      try:
          ...
          self.dictionaries = [
              {**dict(zip(keys, combination)), **self.fixed_parameters} for combination in combinations
          ]
      except Exception as e:
          raise RuntimeError(f"An error occurred while generating parameter combinations: {e}")
  ...
  def run_optimization(self):
      ...
      try:
          ...
          raise RuntimeError(f"An error occurred during the optimization process: {e}")
  ...
  def get_sub_samples(self):
      ...
      if len(self.data) <= end + 2 * length_test:
          raise ValueError("The dataset is too small to create the specified number of sub-samples")
  ...
  def get_best_params_train_set(self):
      ...
      try:
          ...
          raise RuntimeError(f"An error occurred while finding the best parameters: {e}")
  ...
  def get_criterion(self, sample, params):
      ...
      try:
          ...
          raise RuntimeError(f"An error occurred while calculating the criterion: {e}")
  ...
  def get_smoother_result(self):
      ...
      try:
          ...
          for column in self.df_results.columns:
              ...
              if isinstance(self.df_results[column].iloc[0], (float, np.float64)):
  ...
  def test_best_params(self):
      ...
      try:
          ...
          raise RuntimeError(f"An error occurred while testing the best parameters: {e}")
