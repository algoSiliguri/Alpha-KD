...
class TradingStrategy:
    ...
    def validate_vwap_cross(self, close_price, vwap):
        """
            Validates if the close price is significantly greater or smaller than vwap
        """
        # If the value is significantly away from the vwap
        if (abs(close_price - vwap)/close_price)*100 > 0.05:
            return False
        else:
            return True
    ...
    def calculate_vwap(self):
        ...
        try:
                ...
                self.data['VWAP'] = self.data['VWAP'].round()
    ...
    def create_signals(self, df_intraday_30min):
        ...
        try:
            ...
            df_intraday_30min.to_csv(f"SBIN.csv")
