...
params_range = {"sto_period": [7.0, 14.0], "atr_period": [7.0, 14.0]}

params_fixed = {"cost": 0.0001, "leverage": 5}
...
WFO = WalkForwardOptimization(
    df, StoRsiAtr, params_fixed, params_range, length_train_set=6_000, randomness=1.00
)
