...
# Load the dataset
df = pd.read_csv(
    "../Upstox_Data/Create_Database/Nifty50_data/Daily/ADANIENT_Daily.csv",
    index_col="time",
    parse_dates=True,
)
...
params_range = {
    "cci_period": range(14, 16),  # Example range from 14 to 20
    # "atr_period": range(10, 16),  # Example range from 10 to 16
}

# Define the fixed value for the cost parameter
params_fixed = {"cost": 10, "atr_multiplier": 1.5, "atr_period": 15}
