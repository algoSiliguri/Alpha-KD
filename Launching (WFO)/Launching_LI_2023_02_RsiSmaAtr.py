...
params_range = {"fast_sma": [60.0, 80.0], "slow_sma": [120.0, 150.0]}

params_fixed = {"rsi": 20, "cost": 0.0001, "leverage": 5}
...
WFO = WalkForwardOptimization(
    df, RsiSmaAtr, params_fixed, params_range, length_train_set=7_000
)
